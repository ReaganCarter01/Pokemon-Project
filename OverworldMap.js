  ...
  Kitchen: {
    ...
    configObjects: {
      hero: {
        ...
        isPlayerControlled: true,
        x: utils.withGrid(1),
        y: utils.withGrid(3),direction: "up"
      },
      oak: {
        type: "Person",
        x: utils.withGrid(3),
        ...
        talking: [
          {
            events: [
              { type: "textMessage", text: "Hello, Red!", faceHero:"oak"},
              { type: "stand", who: "oak", direction: "up", time: 200}
            ]
          }
        ]
      },
      ...
      gary: {
        ...
        x: utils.withGrid(5),
        y: utils.withGrid(5),
        src: "/images/characters/people/gary.png",
        talking: [
          {
            events: [
              { type: "textMessage", text: "Gary: My Grandpa lets me use his Golden Chansey...", faceHero: "gary" },
              { type: "textMessage", text: "Gary: Let's see how strong it is", faceHero: "gary" },
              { type: "battle", enemyId: "gary", arena: "kitchen-room" }
    ...
    cutsceneSpaces: {
      ...
      [utils.asGridCoord(2,3)]: [{
        ...
        events: [
          ...
          { type: "textMessage", text: "*Its been 10 years after the Great War. Most Pokemon are extinct and can now only be crafted.*"},
          { type: "textMessage", text: "Oak: Hey, Red! Thanks for helping around in the lab. Things just haven't been the same....",faceHero: "oak" },
          { type: "textMessage", text: "Oak: Oh yeah, I almost forgot here's a Pokemon Stone."},
          { type: "textMessage", text: "*Gives Pokemon Stone*"},
          { type: "textMessage", text: "Oak: I remember when the Pokedex still worked. Becoming a Pokemon Trainer is so much harder now..."},
          { type: "textMessage", text: "Oak: Things have changed so much after the war. I guess you're too young to remember."},
          { type: "textMessage", text: "Oak: Take good care of the Cursed Gastly I gave you."},
          { type: "stand", who: "oak", direction: "up", time: 200},
     //     {
   //         type: "changeMap",
     //       map: "Shop",
    ...
    configObjects: {
      ...
      shopNpcA: {
        ...
        talking: [
          {
            events: [
              { type: "textMessage", text: "Shop Owner: All of the chef rivalries have been good for business.", faceHero: "shopNpcA" },
            ]
          }
        ]
      },
    ...
    configObjects: {
      ...
      greenoak: {
        ...
        talking: [
          {
            events: [
              { type: "textMessage", text: "Chef Rootie uses the best seasoning.", faceHero: "greenoak" },
            ]
          }
        ]
      },
      greengary: {
        ...
        talking: [
          {
            events: [
              { type: "textMessage", text: "Finally... a pizza place that gets me!", faceHero: "greengary" },
            ]
          }
        ]
      },
